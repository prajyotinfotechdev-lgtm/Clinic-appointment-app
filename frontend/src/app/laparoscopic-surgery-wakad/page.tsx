...
export default function LaparoscopicSurgeryPage() {
  return (
    <ServicePageLayout
      ...
      heroTitle="Laparoscopic Gynaecological Surgery in Wakad, Pune"
      heroSubtitle="Advanced minimally invasive laparoscopic surgery for gynaecological conditions by Dr. Aparna Kalekar at Kalekar's Star Ortho & Women Care Clinic, Wakad — less pain, faster recovery."
