...
export default function SportsInjuryPage() {
  return (
    <ServicePageLayout
      ...
      heroSubtitle="Fast, effective treatment for all types of sports and athletic injuries by Dr. Rahul Kalekar — helping you recover fully and return to sport safely at Kalekar's Star Ortho & Women Care Clinic, Wakad."
