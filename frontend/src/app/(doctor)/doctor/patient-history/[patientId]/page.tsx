                                            ...
                                            {appt.prescription ? (
                                                <div className="space-y-2.5 print:hidden">
                                                    ...
                                                    <div className="flex justify-end gap-2 pt-1">
                                                        ...
                                                        <button
                                                            // @ts-ignore — prescription exists on runtime Appointment type
                                                    ...
                                                    {/* Hidden Print Template specific to this appointment */}
                                                    <div id={`print-rx-${appt.id}`} className="hidden print:block bg-white text-black text-left">
                                                        <div className="border-b-4 border-teal-900 pb-6 mb-6 flex justify-between items-start">
                                                            ...
                                                            <div className="text-right">
                                                                <h2 className="text-xl font-bold text-teal-900">Dr. {appt.doctor.name}</h2>
                                                                <p className="text-slate-600 text-sm">{appt.doctor.specialization}</p>
                                                                <p className="text-slate-500 text-xs">{DOCTORS.find(d => d.name.toLowerCase().includes(appt.doctor.name.toLowerCase()))?.qualifications || ''}</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex justify-between items-center bg-slate-50 p-4 rounded-lg border border-slate-200 mb-8">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-lg font-bold text-slate-900">{patient.phone}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Date</p>
                                                                <p className="text-lg font-bold text-slate-900">{format(new Date(appt.appointmentDate), "MMM do, yyyy")}</p>
                                                            </div>
                                                        </div>
                                                        {/* @ts-ignore */}
                                                        {appt.prescription.diagnosis && (
                                                            <div className="mb-8">
                                                                ...
                                                                {/* @ts-ignore */}
                                                                <p className="text-xl font-medium text-slate-900">{appt.prescription.diagnosis}</p>
                                                            </div>
                                                        )}
                                                        ...
                                                        {appt.prescription.notes && (
                                                            <div className="mb-16">
                                                                ...
                                                                {/* @ts-ignore */}
                                                                <p className="text-slate-800 whitespace-pre-wrap">{appt.prescription.notes}</p>
                                                            </div>
                                                        )}
                                                        <div className="flex justify-end pt-12">
                                                            <div className="text-center">
                                                                <div className="w-48 border-b-2 border-slate-400 mb-2"></div>
                                                                <p className="font-bold text-teal-900">Dr. {appt.doctor.name}</p>
