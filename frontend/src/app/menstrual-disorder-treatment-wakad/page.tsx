...
export default function MenstrualDisorderPage() {
  return (
    <ServicePageLayout
      ...
      heroSubtitle="Expert diagnosis and personalised treatment for irregular periods, heavy bleeding, and hormonal imbalance by Dr. Aparna Kalekar at Kalekar's Star Ortho & Women Care Clinic, Wakad."
